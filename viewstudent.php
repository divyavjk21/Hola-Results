...
<body>
  ...
  <table class="table">
    <tr>
      ...
      <th class="table_th">Attendance</th>
    ...
    <tr>
      ...
      <td class="table_td"><?php echo $info['S_email']; ?></td>
      <td class="table_td"><?php echo $info['S_name']; ?></td>
      <td class="table_td"><?php echo $info['S_pwd']; ?></td>
      <td class="table_td"><?php echo $info['S_att']; ?></td>
      ...
      <td class="table_td"><?php echo "<a class='btn btn-primary' href='updatestudent.php?student_id={$info['userID']}'>Update</a>"; ?></td>
    </tr>
    <?php } ?>
  </table>
</center>
